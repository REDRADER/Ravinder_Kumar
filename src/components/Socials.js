    ...
    return (
        <div className='socials'>
            <ul className='social--icons'>
                <li>
                    <a href="https://github.com/REDRADER" target="_blank" class="sc--icon">
                ...
                <li>
                    <a href="https://twitter.com/redrader14" target="_blank" class="sc--icon">
                ...
                <li>
                    <a href="https://www.instagram.com/red_rader/" target="_blank" class="sc--icon">
                ...
                <li>
                    <a href="https://www.linkedin.com/in/ravinder14/" target="_blank" class="sc--icon">
